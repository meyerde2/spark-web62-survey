...
public class EvaluationController {
    ...
    public static Route jsonEvaluationPage = (Request request, Response response) -> {
        ...
        combined.put("surveyElementList", surveyElementList);
        combined.put("personalDataEvaluationList", personalDataEvaluationList);
        combined.put("closedQuestionEvaluationList", closedQuestionEvaluationList);
        combined.put("openQuestionEvaluationList", openQuestionEvaluationList);
        combined.put("scoreTableEvaluationList", scoreTableEvaluationList);
